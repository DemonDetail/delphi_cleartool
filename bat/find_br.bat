...
@cd /d X:
@echo on
cleartool find X:\%_search_view%\blois_code_p_l -ver "version(.../%_search_br%/LATEST)" -print >%_outpath%\%_output%
cleartool find X:\%_search_view%\blois_soft_vob -ver "version(.../%_search_br%/LATEST)" -print >>%_outpath%\%_output%
cleartool find X:\%_search_view%\euro5_vob      -ver "version(.../%_search_br%/LATEST)" -print >>%_outpath%\%_output%
cleartool find X:\%_search_view%\gill_vob       -ver "version(.../%_search_br%/LATEST)" -print >>%_outpath%\%_output%
cleartool find X:\%_search_view%\hwi_vob        -ver "version(.../%_search_br%/LATEST)" -print >>%_outpath%\%_output%
cleartool find X:\%_search_view%\gill_dcm624_code  -ver "version(.../%_search_br%/LATEST)" -print >>%_outpath%\%_output%
cleartool find X:\%_search_view%\blois_hmc_code -ver "version(.../%_search_br%/LATEST)" -print >>%_outpath%\%_output%
cleartool find X:\%_search_view%\gwm_secure_vob -ver "version(.../%_search_br%/LATEST)" -print >>%_outpath%\%_output%
