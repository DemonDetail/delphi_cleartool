...
echo Run Quick QAC...
python ..\..\tcg_misc_tool_vob\sw_team_leader_tools\qa.py > gv225086_quick_qac_result.txt
echo Quick Qac Done.

copy gv225086_quick_qac_result.txt %~dp0\_temp\gv225086_quick_qac_result.txt